package com.coupon.go.module.clues.request_handler;

import android.app.Activity;
import android.util.Log;

import com.coupon.go.api_interface.CluesInterface;
...
public class CluesRequestHandler extends RequestHandler implements IServerResponse {
    ...
    public CluesRequestHandler(boolean isJSONObj, boolean shouldShowDialog, Activity activity, CouponApplication context) {
        super(activity);
    ...
    public void callService(final Map<String,String> values, final IServerResponse iLoginSuccess) {
        try {
            if(Util.isMobileInternetOn(activity)){
                ...
                CluesInterface clueInterface = adapter.create(CluesInterface.class);

                Util.showLog("URL : ", UrlConstant.BASE_URL + UrlConstant.GET_CLUE_LIST);
                ...
                clueInterface.requestRegister(latitude,longitude,device_id, new Callback<Response>() {
                    @Override
