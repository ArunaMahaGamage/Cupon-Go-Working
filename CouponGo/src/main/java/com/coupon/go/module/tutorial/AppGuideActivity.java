...
//        btnNext = (Button) findViewById(R.id.btn_next);
        ...
        layouts = new int[]{
                R.layout.activity_guide_page_1,
                R.layout.activity_guide_page_2,
                R.layout.activity_guide_page_3,
                R.layout.activity_guide_page_4,
                R.layout.activity_guide_page_5
        };
...
//                btnSkip.setVisibility(View.GONE);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent i = new Intent(AppGuideActivity.this, DashBoardActivity.class);
                        startActivity(i);
                        finish();
                    }
                }, 1000);
